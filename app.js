...
function creatTable() {
    ...
    var carModel = document.createElement('th');
    carModel.setAttribute('class','last')
    carModel.textContent = '';
    totalRow.appendChild(carModel);
    var modelYear = document.createElement('th');
    modelYear.setAttribute('class','last')
    modelYear.textContent = 'Total price  ';
    totalRow.appendChild(modelYear);
    var manufacturer = document.createElement('th');
    manufacturer.setAttribute('class','last')
    manufacturer.textContent = '';
    totalRow.appendChild(manufacturer);
    var price = document.createElement('th');
    var totalPrice = 0;
    for (var i = 0; i < Car.prototype.allCar.length; i++) {
        totalPrice = totalPrice + Car.prototype.allCar[i].price;
